...
\newcommand{\mytitle}{\ifthesis staticKanren \else Firewall analysis assistant in miniKanren \fi}
\newcommand{\subtitle}{\ifthesis A little miniKanren rewriter \else \fi}
...
\ifpublish
    \input{intro}
    \input{prelim}
    \ifthesis \input{staticKanren} \else \input{firewall} \fi
    \input{ccs}
\else
    \ifthesis \input{staticKanren} \else \input{firewall} \fi
\fi
